class CalorieTracker {
  ...
  _displayCaloriesProgress() {
    ...
    progressEl.classList.toggle('bg-danger', percentage > 100);
  }
...
class App {
  ...
  _newMeal(e) {
    ...
    const bsCollaps = new bootstrap.Collapse(collapseMeal, {
      toggle: true,
    });
  }
  ...
  _newWorkout(e) {
    ...
    const bsCollaps = new bootstrap.Collapse(collapseWorkout, {
      toggle: true,
    });
  }
}
